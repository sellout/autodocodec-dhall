...
[![Packaging status](https://repology.org/badge/tiny-repos/haskell:autodocodec-dhall.svg)](https://repology.org/project/haskell:autodocodec-dhall/versions)
[![latest packaged versions](https://repology.org/badge/latest-versions/haskell:autodocodec-dhall.svg)](https://repology.org/project/haskell:autodocodec-dhall/versions)

[Autodocodec](https://github.com/NorfairKing/autodocodec#readme) support for [Dhall](https://dhall-lang.org/) files

Autodocodec provides generic codecs to convert between many data formats. This adds Dhall to the list of formats.

## usage

**NB**: The only two dependencies of this library are [Autodocodec](https://hackage.haskell.org/package/autodocodec) and [Dhall](https://hackage.haskell.org/package/dhall). Everything else that looks like a direct dependency is inherited from one of those two.
...
This package is licensed under [The GNU AGPL 3.0 or later](./LICENSE). If you need a license for usage that isn’t covered under the AGPL, please contact [Greg Pfeil](mailto:greg@technomadic.org?subject=licensing%20autodocodec-dhall).
